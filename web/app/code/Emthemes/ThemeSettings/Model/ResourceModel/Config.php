 ...
 */
namespace Emthemes\ThemeSettings\Model\ResourceModel;
    ...
    \Magento\Framework\App\Config\ConfigResource\ConfigInterface
{
    ...
    {
        $this->_init('emthemes_config_data', 'config_id');
    }
     ...
     * @return $this
     */
    public function deleteConfig($path, $scope = Magento\Framework\App\Config\ScopeConfigInterface::SCOPE_TYPE_DEFAULT, $scopeId = 0)
    {
        $connection = $this->getConnection();
        $connection->delete(
            $this->getMainTable(),
